...
router.post("/", function(request, response){
    ...
    var medicleid = request.body.medicleid;
    var practicestartdate = request.body.practicestartdate;
    var diabetesstartdate = request.body.diabetesstartdate;
    var diabeticexp = request.body.diabeticexp;
    ...
    try{
        ...
        req.execute("dbo.Update_Doctor", function(err, data){
            if(err){
