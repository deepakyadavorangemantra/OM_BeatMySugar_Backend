                                                           ...
                                                           ' <tr>'+
                                                            ...
                                                            'Haryana - 121 001. INDIA.</p>'+
                                                                         ...
                                                                         ' </tr>'+
                                                                           ...
                                                                           ' <span style="font-weight: bold; font-size: 15px">'+billingname+'</span><p>'+billingaddress+
                                                                                  ...
                                                                                  '<span style="font-weight: bold; font-size: 15px">'+shippingname+'</span><p style="font-size:13px">'+deliveryaddress+
                                                                            ...
                                                                            '<table style="font-size: 13px;border-collapse: collapse;margin-bottom:0px;word-break: break-all" border="1" cellspacing="0" cellpadding="0">'+
                                                                             ' <tr >'+
                                                                              '<td  style="text-align: right; padding: 1%"><span style="font-weight: bold">'+
                                                                               'Sub total</span></td><td style="text-align: right; padding-right: 1%;width:40%"> &#8377; '+ordervalue+
                                                                               ' </td>'+
                                                                                
                                                                             ' </tr>'+
                                                                             ' <tr style="width:100%;">'+
                                                                              '<td  style="text-align: right; padding: 1%"><span style="font-weight: bold">'+
                                                                               'Offer Discount</span></td><td style="text-align: right; padding-right: 1%;width:40%"> &#8377; '+offeramount+
                                                                                '</td>'+
                                                                                
                                                                              '</tr>'+
                                                                             ' <tr style="width:100%;">'+
                                                                             ' <td  style="text-align: right; padding: 1%"><span style="font-weight: bold">'+
                                                                              ' Shipping Charge</span></td><td style="text-align: right; padding-right: 1%;width:40%"> &#8377; '+shippingcharges+
                                                                                '</td>'+
                                                                             ...
                                                                             ' <tr style="width:100%;">'+
                                                                              '<td  style="text-align: right; padding: 1%"><span style="font-weight: bold">'+
                                                                               'COD Service Charge</span></td><td style="text-align: right; padding-right: 1%;width:40%"> &#8377; '+coddeliverycharges+
                                                                               ' </td>'+
                                                                             ...
                                                                             ' </tr>'+
                                                                              ...
                                                                              '<tr style="width:100%;">'+
                                                                              '<td  style="text-align: right; padding: 1%"><span style="font-weight: bold">'+
                                                                               'Total (Inclusive of all Taxess)</span></td><td style="text-align: right; padding-right: 1%;width:40%"> &#8377; '+netcost+
                                                                                '</td>'+
                                                                                
                                                                              '</tr>'+
                                                                              '<tr style="width:100%;">'+
                                                                              '<td  style="text-align: right; padding: 1%"><span style="font-weight: bold">'+
                                                                              'Payment Mode</span></td><td style="text-align: right; padding-right: 1%;width:20%">'+paymentmode+
                                                                                '</td>'+
