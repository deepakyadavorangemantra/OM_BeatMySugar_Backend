...
router.post("/", function(request, response){
    ...
    var startdateofpractice = request.body.startdateofpractice;
    ...
    try{
        ...
        req.input('startdateofpractice',sql.NVarChar(200), startdateofpractice);
        ...
        req.execute("dbo.Update_Nutritionist", function(err, data){
            if(err){
