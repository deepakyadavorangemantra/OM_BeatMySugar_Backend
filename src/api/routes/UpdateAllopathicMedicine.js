...
router.post("/", function(request, response){
    ...
    var schedule_of_drug = request.body.schedule_of_drug;
    ...
    var prescription_required = request.body.prescription_required;
    ...
    try{
        ...
        req.input('schedule_of_drug',sql.NVarChar(100), schedule_of_drug);
        ...
        req.input('prescription_required',sql.NVarChar, prescription_required);
        ...
        req.execute("dbo.Update_AllopathyMedicine", function(err, data){
            if(err){
